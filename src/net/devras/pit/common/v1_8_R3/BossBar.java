...
public class BossBar {
	...
	public static void sendPacket(Player player,
		...
		entityPlayer.playerConnection
				.sendPacket((net.minecraft.server.v1_8_R3.Packet) destroyEntityPacket);
	}

	@SuppressWarnings("rawtypes")
	public static void sendPacket2(Player player,
			PacketPlayOutSpawnEntityLiving mobPacket) {
		EntityPlayer entityPlayer = ((CraftPlayer) player).getHandle();

		entityPlayer.playerConnection
				.sendPacket((net.minecraft.server.v1_8_R3.Packet) mobPacket);
	}
	...
	public static DataWatcher getWatcher(String text, int health) {
		...
		watcher.a(3, (Byte) (byte) 1); // Show name, 1 = show, 0 = don't show
	...
	public static void displayTextBar(String text, final Player player) {
		...
		}.runTaskLater(Bukkit.getPluginManager().getPlugin("Lobby"), 120L);
	}
